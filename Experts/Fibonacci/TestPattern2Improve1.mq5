...
input double open_ratio=0.55;
input double tp_ratio=1.1;
input double sl_ratio=-1.95;
input double my_lots=0.1;
input int position_max=10;
input int num_zigzag=9;
input int point_range=1150;
input int tau_zigzag=45;
input int c_mode=1;
input double z_ratio=1.0;
...
//--- create timer
   ...
   s.InitStrategy(open_ratio,tp_ratio,sl_ratio,my_lots,position_max,point_range,num_zigzag,tau_zigzag,c_mode); 
